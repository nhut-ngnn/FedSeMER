...
def normalize_model_name(model_name):
    value = "fedsemer" if model_name is None else str(model_name).strip().lower()
...
def build_model(model_name, num_classes, text_input_dim=768, audio_input_dim=768, **model_kwargs):
    ...
    if normalized_name == "fedsemer":
        from src.architecture.FedSeMER import FedSeMER
