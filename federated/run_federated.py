...
def _load_yaml_config(path):
    ...
    defaults["aggregation_weighting"] = fed.get("aggregation_weighting")
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        choices=["static", "confidence_mass", "dynamic"],
        help="Server aggregation ablation: labeled-only, confidence mass, or accepted pseudo-label count.",
    )
    parser.add_argument(
        "--best_metric",
        type=str,
    ...
    if args.aggregation_weighting is None:
        args.aggregation_weighting = "static" if args.weight_by == "labeled" else "dynamic"
