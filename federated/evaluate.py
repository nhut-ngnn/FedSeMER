...
from federated.utils import append_csv, ensure_dir, list_clients, load_state_dict, resolve_worker_count
...
def evaluate_checkpoint(
    ...
    worker_count = resolve_worker_count(num_workers, len(clients), "federated evaluation")
