...
def main():
    ...
    model_name = normalize_model_name(
        model_cfg.get("name") or fed_cfg.get("model_name") or "fedsemer"
    )
    ...
    if args.exp_name:
        ...
        exp_name = run_id if model_name == "fedsemer" else f"{run_id}_{model_name}"
    else:
        exp_name = f"{dataset}_federated" if model_name == "fedsemer" else f"{dataset}_{model_name}_federated"
